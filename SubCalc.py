...
def subChall():
    ...
    for x in range (5):
        ...
        print(question)
        while True:
            while question_counter > 0 and lives > 0:
...
#  print("Welcome to the Subnet challenge.\nHere you will be presented with a question, and you must type in your answer.")
#  print("If you get 5 correct, you win and may continue to the next room.")
#  print("But beware. If you fail 3 times, you will go to 'Detention', where you must answer 5 correctly.\nIn 'Detention' you will be aided by a subnet calculator.")
#  print("If you lose all 3 lives again, you will once again go to 'Detention'. Only, now you must answer 10 correctly, to get out.")
...
#  ready = input("Ready to begin? Yes/No").lower
#  
#  if ready == "yes":
